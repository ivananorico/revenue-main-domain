...
// Fetch application details with all related information including renter info
try {
    $stmt = $pdo->prepare("
        SELECT 
            a.*, 
    ...
    // Check for stall rights certificate and lease contract
    $has_stall_rights = false;
    $has_lease_contract = false;
    $stall_rights_cert = null;
    $lease_contract = null;

    foreach ($documents as $doc) {
        if ($doc['document_type'] === 'stall_rights_certificate') {
            $has_stall_rights = true;
            $stall_rights_cert = $doc;
        }
        if ($doc['document_type'] === 'lease_contract') {
...
<head>
    ...
    <title>Documents Submitted - Municipal Services</title>
...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto px-6 py-8 max-w-6xl">
        ...
        <div class="success-section">
            ...
            <h2 class="text-2xl font-bold mb-2">Documents Successfully Submitted!</h2>
            <p class="text-white/90 text-lg">All required documents have been submitted and are under final review.</p>
        </div>
            ...
            <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div class="flex-1">
                    ...
                    <p class="text-gray-700">
                        All documents have been submitted successfully. Your application is now in the final review phase. 
                        You will be notified once your stall rights certificate and lease contract are ready.
                    </p>
                </div>
                <div class="status-badge status-documents_submitted">
                ...
                <div class="info-item">
                    ...
                    <div class="space-y-2">
                        ...
                        <p><span class="text-gray-600">Monthly Rent:</span> 
                           <span class="font-semibold text-green-600">₱<?= number_format($application['stall_price'], 2) ?></span>
                        </p>
                    </div>
                </div>
            ...
            <div class="contract-details">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <p class="font-semibold text-green-600">₱<?= number_format($application['contract_rent'], 2) ?></p>
                    </div>
                </div>
            </div>
            <?php endif; ?>
        ...
        <div class="info-card">
            <h3 class="text-xl font-bold text-gray-800 mb-4">📎 All Uploaded Documents</h3>
            <div class="space-y-3">
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-6">
            ...
            <ul class="list-disc list-inside text-blue-700 space-y-2">
                <li>Your documents are undergoing final verification</li>
                <li>Stall rights certificate will be issued upon approval</li>
                <li>Lease contract will be generated and sent to you</li>
                <li>You will receive notification when your stall is ready for operation</li>
                <li>Market orientation may be scheduled for new renters</li>
            </ul>
            <div class="mt-4 p-4 bg-white rounded-lg border border-blue-200">
                <h4 class="font-semibold text-blue-800 mb-2">📞 Need Assistance?</h4>
                <p class="text-blue-700 text-sm">
                    Contact the Market Administration Office for any questions about your documents or stall setup.
                </p>
            </div>
        </div>
